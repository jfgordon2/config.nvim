...
---@field cmp custom.utils.cmp
---@field format custom.utils.format
---@field inject custom.utils.inject
---@field lsp custom.utils.lsp
---@field plugin custom.utils.plugin
---@field info fun(msg: string|string[], opts?: LazyNotifyOpts)
---@field warn fun(msg: string|string[], opts?: LazyNotifyOpts)
---@field error fun(msg: string|string[], opts?: LazyNotifyOpts)
local M = {}
...
--- NotificationFunctions Title Modifier
